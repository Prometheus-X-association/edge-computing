...
def configure_worker_credential(name: str, cred: dict, app: str, namespace: str = None) -> str | None:
    """
    ...
    secret = create_image_pull_secret(name=name, user=cred.username, passwd=cred.password, namespace=namespace, app=app,
                                      projected=True)
