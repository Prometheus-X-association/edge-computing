...
class PEWSpecDataSrcAuth(BaseModel):
    ...
    @field_serializer("secret", mode="plain", return_type=str)
    def serialize_secret(self, secret: SecretStr, info: Any) -> str:
...
class PEWSpecWorkerSrcMethod(StrEnum):
    """
    Image pull approach
    """
...
class PEWSpecWorkerSrcAuth(BaseModel):
    """
...
class PEWSpecWorkerSrc(BaseModel):
    """
    Worker image location
    """

    method: Annotated[PEWSpecWorkerSrcMethod, Field(examples=["DOCKER"])]
    """
    Image pull approach
    ...
    """
    auth: PEWSpecWorkerSrcAuth | None = None
    """
    Credentials for remote image collection
    """


class PEWSpecWorkerDst(BaseModel):
    """
    ...
    """
    Worker cached in local registry
    """
    name: Annotated[
        str | None,
        Field(
...
class PEWSpecWorker(BaseModel):
    ...
    src: PEWSpecWorkerSrc
    """
    Worker image location
    """
    dst: PEWSpecWorkerDst | None = None
    """
    Worker image destination configuration
    """
    command: Annotated[
